...
export function ListItemForm({ open, onClose, onAddItem }: ItemFormProps) {
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <DialogActions>
                <Button onClick={onClose}>{intl.formatMessage({id: 'list-item-form.cancel'})}</Button>
                <Button onClick={handleSubmit} variant="contained" color="secondary" disabled={!validateForm}>
